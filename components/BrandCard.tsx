...
const BrandCard = () => {
  ...
  const conferenceRef = useRef<HTMLSpanElement>(null);
  ...
  useEffect(() => {
    ...
    import("gsap").then(({ gsap }) => {
      ...
      tl.set(logoWrapRef.current, {
        ...
        .to(conferenceRef.current, { autoAlpha: 1, y: 0, duration: 0.55 }, 0.52)
      ...
      <div className="tw:relative tw:flex tw:flex-col tw:items-center tw:gap-6 tw:px-1.5 tw:py-1.5 tw:text-center">
        ...
        <div className="tw:font-yk tw:leading-none">
          ...
          <div className="tw:flex tw:flex-wrap tw:items-baseline tw:justify-center tw:gap-3.5">
            <span
              ref={conferenceRef}
              className="tw:text-[clamp(30px,4vw,52px)] tw:font-semibold tw:tracking-normal"
            >
              conference
            </span>
          ...
          <div
            ref={dateRef}
            className="tw:mt-4 tw:block tw:text-2xl tw:font-medium tw:tracking-normal"
          >
            Early December
          </div>
          <div
            ref={venueRef}
            className="tw:mt-2 tw:block tw:text-xl tw:font-medium tw:tracking-normal"
          >
